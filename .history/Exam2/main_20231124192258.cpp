...
void Initscene() {
    ...
    static GLfloat glfMatAmbient[]  = {0.229500, 0.088250, 0.027500, 1.000000};
    static GLfloat glfMatDiffuse[]  = {0.550800, 0.211800, 0.066000, 1.000000};
    static GLfloat glfMatspecular[] = {0.580594, 0.223257, 0.069570, 1.000000};
    static GLfloat glfMatEmission[] = {0, 0, 0, 1};
    static GLfloat fShininess = 51.200001;
