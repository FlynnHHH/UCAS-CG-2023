...
void Initscene() {
    ...
    static GLfloat glfMatAmbient[]  = {0.250000, 0.148000, 0.064750, 1.000000};
    static GLfloat glfMatDiffuse[]  = {0.400000, 0.236800, 0.103600, 1.000000};
    static GLfloat glfMatspecular[] = {0.774597, 0.458561, 0.200621, 1.000000};
    static GLfloat glfMatEmission[] = {0, 0, 0, 1};
    static GLfloat fShininess = 76.800003;
