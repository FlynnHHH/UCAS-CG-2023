...
struct item{
  ...
  bool operator==(const item& other) const {
        return {(this->validpair.x() == other.validpair.x() && this->validpair.y() == other.validpair.y() \
            || this->validpair.x() == other.validpair.y() && this->validpair.y() == other.validpair.x()) && this->cost == other.cost};
    }
};
struct CompareCost {
